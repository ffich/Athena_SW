...
// Created by the Microchip USBConfig Utility, Version 2.7.1.0, 4/5/2015, 20:38:22
...
USB_TPL usbTPL[] =
{
    { INIT_CL_SC_P( 0x08ul, 0x06ul, 0x50ul ), 0, 0, {TPL_CLASS_DRV} } // MS1
    ,
    { INIT_CL_SC_P( 0x08ul, 0x05ul, 0x50ul ), 0, 1, {TPL_CLASS_DRV} } // MS2
};