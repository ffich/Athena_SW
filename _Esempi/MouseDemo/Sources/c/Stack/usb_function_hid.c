...
* Output:       None
* Author:	F.Ficili
* Description:	Enable the HID endpoint
* Date:		07/03/15
************************************************************************/
...
/************************************************************************
* Function:     USBCBCheckOtherReq
* Input:        None
* Output:       None
* Author:	F.Ficili
* Description:	Check HID request
* Date:		07/03/15
************************************************************************/
void USBCBCheckOtherReq(void)
{
...
/************************************************************************
* Function:     USER_USB_CALLBACK_EVENT_HANDLER
* Input:        None
* Output:       None
* Author:	F.Ficili
* Description:	Manage USB events
* Date:		07/03/15
************************************************************************/
